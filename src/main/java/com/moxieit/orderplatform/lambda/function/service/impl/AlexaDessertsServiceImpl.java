...
public class AlexaDessertsServiceImpl implements AlexaService{
	...
	public BaseResponse serveLex(AlexaDTO alexaDTO, Context context) {
		...
		outputSpeech.setSsml(
				"<speak>We have Chiku shake cost 3 dollors , Mango Lassi cost 2 dollors ,Plain Falooda cost 2 dollors, Tea cost 2 dollors and Coffee cost 2 dollors. What would you like.</speak>");
		outputSpeech.setType("SSML");
		Card card = new Card();
		card.setTitle("Audio");
		card.setType("Simple");
		card.setContent("We have Chiku shake cost 3 dollors , Mango Lassi cost 2 dollors ,Plain Falooda cost 2 dollors, Tea cost 2 dollors and Coffee cost 2 dollors. What would you like.");
